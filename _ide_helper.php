...
namespace {
    ...
    class Slug extends \Somepony\L4CyrillicSlug\Facades\Slug{
         ...
         * @static 
         */
        public static function make($string, $separator = '-', $transliterate = false, $translate = false){
            return \Somepony\L4CyrillicSlug\Slug::make($string, $separator, $transliterate, $translate);
        }
